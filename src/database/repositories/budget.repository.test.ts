...
describe('BudgetRepository', () => {
  describe('setBudget (upsert)', () => {
    ...
    test('updates currency on existing budget', () => {
      budgetRepo.setBudget({ group_id: groupId, category: 'Food', month: '2024-01', limit_amount: 300 });
      const updated = budgetRepo.setBudget({
        group_id: groupId,
        category: 'Food',
        month: '2024-01',
    ...
    test('different months are separate budgets', () => {
      const b1 = budgetRepo.setBudget({ group_id: groupId, category: 'Food', month: '2024-01', limit_amount: 300 });
      const b2 = budgetRepo.setBudget({ group_id: groupId, category: 'Food', month: '2024-02', limit_amount: 350 });
      expect(b1.id).not.toBe(b2.id);
    });

    test('different categories are separate budgets', () => {
      const b1 = budgetRepo.setBudget({ group_id: groupId, category: 'Food', month: '2024-01', limit_amount: 300 });
      const b2 = budgetRepo.setBudget({ group_id: groupId, category: 'Rent', month: '2024-01', limit_amount: 1000 });
      expect(b1.id).not.toBe(b2.id);
    });
  });
  ...
  describe('findById', () => {
    test('returns budget for existing id', () => {
      const created = budgetRepo.setBudget({ group_id: groupId, category: 'Food', month: '2024-01', limit_amount: 300 });
  ...
  describe('findByGroupCategoryMonth', () => {
    ...
    test('scoped to group', () => {
      ...
      budgetRepo.setBudget({ group_id: group2.id, category: 'Food', month: '2024-01', limit_amount: 300 });
      expect(budgetRepo.findByGroupCategoryMonth(groupId, 'Food', '2024-01')).toBeNull();
    });
  });
  ...
  describe('getLatestBudget', () => {
    test('returns most recent budget by month', () => {
      budgetRepo.setBudget({ group_id: groupId, category: 'Food', month: '2024-01', limit_amount: 300 });
      budgetRepo.setBudget({ group_id: groupId, category: 'Food', month: '2024-03', limit_amount: 350 });
      budgetRepo.setBudget({ group_id: groupId, category: 'Food', month: '2024-02', limit_amount: 320 });
  ...
  describe('findByGroupId', () => {
    test('returns all budgets for group ordered month desc, category asc', () => {
      budgetRepo.setBudget({ group_id: groupId, category: 'Rent', month: '2024-01', limit_amount: 1000 });
      budgetRepo.setBudget({ group_id: groupId, category: 'Food', month: '2024-02', limit_amount: 300 });
      budgetRepo.setBudget({ group_id: groupId, category: 'Food', month: '2024-01', limit_amount: 250 });
  ...
  describe('delete', () => {
    test('removes budget from database', () => {
      const budget = budgetRepo.setBudget({ group_id: groupId, category: 'Food', month: '2024-01', limit_amount: 300 });
  ...
  describe('getBudgetProgress', () => {
    test('returns progress with correct percentage', () => {
      budgetRepo.setBudget({ group_id: groupId, category: 'Food', month: '2024-01', limit_amount: 200 });
    ...
    test('is_exceeded true when spent > limit', () => {
      budgetRepo.setBudget({ group_id: groupId, category: 'Food', month: '2024-01', limit_amount: 100 });
    ...
    test('percentage is 0 when limit_amount is 0', () => {
      budgetRepo.setBudget({ group_id: groupId, category: 'Zero', month: '2024-01', limit_amount: 0 });
  ...
  describe('hasBudget', () => {
    ...
    test('true even if budget is from an older month', () => {
      budgetRepo.setBudget({ group_id: groupId, category: 'Food', month: '2023-01', limit_amount: 300 });
      expect(budgetRepo.hasBudget(groupId, 'Food')).toBe(true);
    });
  });
